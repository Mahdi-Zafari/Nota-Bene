            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="{{ asset('images/app_logo.png') }}" alt="{{ config('app.name', 'Nota Bene') }}" class="h-10 w-auto rounded-full object-contain shadow-lg">
                        <span class="ml-3 text-white text-lg font-semibold">{{ config('app.name', 'Nota Bene') }}</span>
                    </a>
                </div>
