...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Create Note</h1>

        <form action="{{ route('notes.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="6" required class="block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:bg-gray-700 dark:text-white transition duration-150 ease-in-out"></textarea>
            </div>
